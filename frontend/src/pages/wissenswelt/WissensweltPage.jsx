  ...
  return (
    <div className="wissen-page">
      ...
      <p>
        ...
        Sprachen. Die Grundlage bildet <strong>Wiktionary</strong> – ein freies
      ...
      <p>
        ...
        automatisch erzeugten Transkriptionen sind in der Regel gut, können aber
        bei seltenen, fremdsprachigen oder unregelmäßigen Wörtern ungenau sein.
      </p>

      {/* ── Was Reimwelt kann ── */}
      <h2>Was Reimwelt kann</h2>
      <ul>
        <li>
          <strong>Sprachübergreifende Reime</strong> – z. B. deutsches Wort mit
          englischem oder französischem Pendant
        </li>
        <li>
      ...
      <h3>Homographe</h3>
      <p>
        Manche deutschen Wörter werden je nach Bedeutung unterschiedlich betont
        und ausgesprochen – zum Beispiel <em>„modern"</em> als Adjektiv
      ...
      <p>
        ...
        verlässliche Häufigkeitswerte. Solche Wörter erhalten einen Standardwert
        und können im Sortiermodus „Häufigkeit" nach unten rutschen.
      </p>
      ...
      <div className="wissen-callout">
        <p>
          <strong>Tipp:</strong> Stößt du auf einen offensichtlichen IPA-Fehler
          oder ein fehlendes Reim-Paar? Homographe und Transkriptionsfehler sind
          die häufigsten Ursachen. Die{" "}
          <Link to="/wissenswelt/homographe">Homographe-Seite</Link> erklärt das
      ...
      <div className="wissen-section-divider">
        <span className="wissen-section-divider-label">Tiefer eintauchen</span>
      </div>
