...
const FEET = [
  ...
  },
  {
    ...
    line: "Mächtiger, der du die Wipfel dir beugst, …",
    author: "Friedrich Rückert",
    work: "An den Sturmwind",
  },
  {
    name: "Anapäst",
    schema: "· · ˈ",
    ...
    <div className="wissen-layout">
      ...
      <div className="wissen-page">
        ...
        <p>
          ...
          Betonungsmuster eines Wortes, Verses oder Songtexts.
        </p>
        <p>
          ...
          <MeterDots pattern="10" label="betont, unbetont" /> Die kleinste
          rhythmische Einheit heißt <strong>Versfuß</strong>; reiht man mehrere
          aneinander, ergibt sich ein vollständiger Vers. Vier Jamben
          hintereinander heißen etwa „vierhebiger Jambus" – das Maß von
