  ...
  return (
    <div className="wissen-layout">
      ...
      <div className="wissen-page">
        ...
        <p>
          Der Inhalt-„Tenor" reimt auf <em>Mentor, Viktor, Sponsor</em>{" "}
          (Betonung vorne). Der Sänger-„Tenor" reimt auf{" "}
          <em>Komfort, Tresor, hervor</em> (Betonung hinten) – zwei Wörter, die
          nicht einmal miteinander reimen, obwohl sie sich buchstabengleich
          gegenüberstehen.
        </p>
