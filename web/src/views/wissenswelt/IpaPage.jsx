    ...
    <div className="wissen-layout">
      ...
      <div className="wissen-page">
        ...
        <ul>
          ...
          <li>
            <em>„Humor"</em> und <em>„Labor"</em> reimen, während{" "}
            <em>„Humor"</em> und <em>„Komfort"</em> ebenfalls reimen – das zeigt
        ...
        <ul>
          <li>
            <strong>Suchleiste:</strong> Nach einer Suche, erscheint rechts die
        ...
        <p>
          Ein Paradebeispiel ist die Endung <em>-ig</em>. In der Standardlautung
